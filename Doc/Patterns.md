...
- **`dsp::linalg::CaponProcessor`** — `linalg/include/linalg/capon_processor.hpp:66`
...
- **`dsp::linalg::MatrixOpsROCm`** — `linalg/include/linalg/matrix_ops_rocm.hpp:54`
...
- **`PyCaponProcessor`** — `linalg/python/py_capon_rocm.hpp:33`
  - Pybind-Adapter над `dsp::linalg::CaponProcessor`: numpy↔GPU, GIL-release в `Compute*`. Принимает `ROCmGPUContext&` (`py_gpu_context.hpp`), backend берётся из `ctx.backend()` — единый паттерн для всех модулей DSP-GPU.
...
- **`dsp::linalg::IMatrixRegularizer`** — `linalg/include/linalg/i_matrix_regularizer.hpp:45`
...
- **`dsp::linalg::AdaptBeamformOp`** — `linalg/include/linalg/operations/adapt_beam_op.hpp:33`
...
- **`dsp::linalg::CaponInvertOp`** — `linalg/include/linalg/operations/capon_invert_op.hpp:48`
  - Обёртка инверсии ковариационной матрицы.
- **`dsp::linalg::CaponReliefOp`** — `linalg/include/linalg/operations/capon_relief_op.hpp:35`
...
- **`dsp::linalg::ComputeWeightsOp`** — `linalg/include/linalg/operations/compute_weights_op.hpp:33`
...
- **`dsp::linalg::CovarianceMatrixOp`** — `linalg/include/linalg/operations/covariance_matrix_op.hpp:33`
