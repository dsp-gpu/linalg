...
//
// ЧТО:    Загружает MATLAB-файлы заказчика (x/y_data.txt, signal_matlab.txt,
//         z_values.txt) и верифицирует CaponProcessor против эталона.
//         f0=3921150000 Hz, c=299792458 m/s, 340 антенных секций.
// ЗАЧЕМ:  Реальные данные выявляют ошибки физической модели (формула getU),
//         которые синтетические тесты не поймают.
// ПОЧЕМУ: ENABLE_ROCM. Эталон — z_values.txt (MATLAB-вычисление).
//
